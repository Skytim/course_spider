    ...
    for b in range(10):
        for c in range(10):
            for d in range(10):
                for e in range(10):
                    for f in range(10):
                        url="http://newdoc.nccu.edu.tw/teaschm/1032/statistic.jsp-tnum="+str(a)+str(b)+str(c)+str(d)+str(e)+str(f)+".htm"
                        try:
                            ...
                            print("無法抓到教師編號"+str(a)+str(b)+str(c)+str(d)+str(e)+str(f))
